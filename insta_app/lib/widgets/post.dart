...
class Post extends StatefulWidget {
  ...
  int getLikeCount(likes) {
    // if no likes return 0 , add a like
    if(likes == null){
      return 0;
    }
    int count = 0;
...
class _PostState extends State<Post> {
  ...
  buildPostHeader(){
      return FutureBuilder(future: usersRef.doc(ownerId).get(),builder: (context, snapshot){
        if(!snapshot.hasData){
          ...
          children: [
            ...
            showHeart ? Animator(
              ...
              builder: (context, anim, child) => Transform.scale(
                ...
                ),// Icon(Icons.favorite, size: 80.0, color: Colors.red,): Text(""),
    ) : Text(""),
    ],
        ),
      );
