  ...
  Scaffold buildUploadForm(){
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Caption Post", style:
          TextStyle(
            color: Colors.black,
          ),
        ),
        actions: [
          FlatButton(onPressed: isUploading ? null : () => handleSubmit(), child: Text(
      ...
      body: ListView(
        children: [
          ...
          Container(
            ...
            child: RaisedButton.icon(onPressed: getUserLocation, icon: Icon(
              Icons.my_location,
              color: Colors.white,
            ), label: Text("Use Current Location", style:
              TextStyle(
                color: Colors.white,
              ),
            ),
